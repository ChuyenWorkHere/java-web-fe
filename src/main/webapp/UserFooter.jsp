...
<!-- footer start -->
                        ...
                        <div class="col-xl-3 col-lg-5 col-md-6 ">
                            <div class="footer-widget mb-40">
                                <div class="footer-logo">
                                    <a href="index.html"><img src="../user/../user/img/logo/footer-logo.png" alt=""></a>
                                </div>
                                ...
                                <div class="footer-time d-flex mt-30">
                                    <div class="time-icon">
                                        <img src="../user/img/icon/time.png" alt="">
                                    </div>
                                    <div class="time-text">
                        ...
                        <div class="col-xl-3 col-lg-5 col-md-6">
                            <div class="footer-widget mb-40">
                                <div class="footer-banner">
                                    <a href="shop.html"><img src="../user/img/banner/add.jpg" alt=""></a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="search-wrap">
        ...
        <script src="../user/js/one-page-nav-min.js"></script>
        ...
        <script src="../user/js/jquery.final-countdown.min.js"></script>

        ...
        <main>
            ...
            <section class="slider-area pos-relative">
                <div class="slider-active">
                    <div class="single-slider slide-1-style slide-height d-flex align-items-center" data-background="../user/img/slider/slide1.jpg">
                        <div class="shape-title bounce-animate">
                            <h2>UX</h2>
                        </div>
                        <div class="shape-icon bounce-animate">
                            <img src="../user/img/slider/shape-icon.png" alt="">
                        </div>
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-xl-7">
                                    <div class="slide-content">
                                        <span data-animation="fadeInRight" data-delay=".2s">Nội thất mới nhất</span>
                                        <h1 data-animation="fadeInUp" data-delay=".5s">Ghế Ăn Bọc Đệm Synnes</h1>
                                        <div class="slide-btn">
                                            <a class="btn theme-btn" href="shop.html" data-animation="fadeInLeft" data-delay=".7s">mua ngay</a>
                                            <a class="btn white-btn" href="shop.html" data-animation="fadeInRight" data-delay=".9s">danh mục</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-5">
                                    <div class="slide-shape1" data-animation="bounceInRight" data-delay=".9s"><img src="../user/img/slider/shape1.png" alt=""></div>
                                    <div class="slide-shape2" data-animation="bounceInRight" data-delay="1.2s"><img src="../user/img/slider/shape2.png" alt=""></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="single-slider slide-1-style slide-height d-flex align-items-center" data-background="../user/img/slider/slide1-1.jpg">
                        <div class="shape-title bounce-animate">
                            <h2>UX</h2>
                        </div>
                        <div class="shape-icon bounce-animate">
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-xl-5">
                                    <div class="slide-shape1" data-animation="bounceInRight" data-delay=".9s"><img src="../user/img/slider/shape3.png" alt=""></div>
                                    <div class="slide-shape2" data-animation="bounceInRight" data-delay="1.1s"><img src="../user/img/slider/shape4.png" alt=""></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="banner mb-30">
                                <a href="shop.html"><img src="../user/img/banner/banner-1/banner1.jpg" alt=""></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="banner mb-30">
                                <a href="shop.html"><img src="../user/img/banner/banner-1/banner2.jpg" alt=""></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="banner mb-30">
                                <a href="shop.html"><img src="../user/img/banner/banner-1/banner3.jpg" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-5 col-lg-12">
                            <div class="area-title mb-50">
                                ...
                                <p>Khám phá vô số sản phẩm đa dạng của chúng tôi</p>
                            </div>
                        </div>
                                        ...
                                        <div class="product-slider owl-carousel">
                                                ...
                                                <div class="product-wrapper mb-50">
                                                    <div class="product-img mb-25">
                                                        <a href="product-details.html">
                                                            ...
                                                            <img class="secondary-img" src="../user/../user/img/product/pro4.jpg" alt="">
                                                        </a>
                                                        <div class="product-action text-center">
                                                            <a href="#" title="Shoppingb Cart">
                                                                <i class="flaticon-shopping-cart"></i>
                                            ...
                                            <div class="pro-item">
                                                <div class="product-wrapper mb-50">
                                                    <div class="product-img mb-25">
                                                        <a href="product-details.html">
                                                            ...
                                                            <img class="secondary-img" src="../user/../user/img/product/pro6.jpg" alt="">
                                                        </a>
                                                        <div class="product-action text-center">
                                                            <a href="#" title="Shoppingb Cart">
                                                                <i class="flaticon-shopping-cart"></i>
                                                ...
                                                <div class="product-wrapper mb-50">
                                                    <div class="product-img mb-25">
                                                        <a href="product-details.html">
                                                            <img src="../user/../user/img/product/pro4.jpg" alt="">
                                                            <img class="secondary-img" src="../user/../user/img/product/pro8.jpg" alt="">
                                                        </a>
                                                        <div class="product-action text-center">
                                                            <a href="#" title="Shoppingb Cart">
                                                                <i class="flaticon-shopping-cart"></i>
                                            ...
                                            <div class="pro-item">
                                                <div class="product-wrapper mb-50">
                                                    <div class="product-img mb-25">
                                                        <a href="product-details.html">
                                                            <img src="../user/../user/img/product/pro5.jpg" alt="">
                                                            <img class="secondary-img" src="../user/../user/img/product/pro2.jpg" alt="">
                                                        </a>
                                                        <div class="product-action text-center">
                                                            <a href="#" title="Shoppingb Cart">
                                                ...
                                                <div class="product-wrapper mb-50">
                                                    <div class="product-img mb-25">
                                                        <a href="product-details.html">
                                                            <img src="../user/../user/img/product/pro7.jpg" alt="">
                                                            <img class="secondary-img" src="../user/../user/img/product/pro4.jpg" alt="">
                                                        </a>
                                                        <div class="product-action text-center">
                                                            <a href="#" title="Shoppingb Cart">
                                            ...
                                            <div class="pro-item">
                                                <div class="product-wrapper mb-50">
                                                    <div class="product-img mb-25">
                                                        <a href="product-details.html">
                                                            <img src="../user/../user/img/product/pro8.jpg" alt="">
                                                            <img class="secondary-img" src="../user/../user/img/product/pro1.jpg" alt="">
                                                        </a>
                                                        <div class="product-action text-center">
                                                            <a href="#" title="Shoppingb Cart">
                                                                <i class="flaticon-shopping-cart"></i>
                                                ...
                                                <div class="product-wrapper mb-50">
                                                    <div class="product-img mb-25">
                                                        <a href="product-details.html">
                                                            <img src="../user/../user/img/product/pro6.jpg" alt="">
                                                            <img class="secondary-img" src="../user/../user/img/product/pro4.jpg" alt="">
                                                        </a>
                                                        <div class="product-action text-center">
                                                            <a href="#" title="Shoppingb Cart">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-5 col-lg-8 col-md-7">
                            <div class="area-title mb-50">
                                <h2>Bán Chạy Nhất</h2>
                                <p>Khám phá các sản phẩm bán chạy của chúng tôi</p>
                            </div>
                        </div>
                        <div class="col-xl-7 col-lg-4 col-md-5">
                            <div class="vue-btn text-left text-md-right mb-50">
                                <a href="shop.html" class="btn theme-btn">Bộ Sưu Tập</a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xl-5 col-lg-5">
                            <div class="top-seller mb-50">
                                <img src="../user/img/banner/top-seller/banner1.jpg" alt="">
                                <div class="seller-box text-center">
                                    <div class="top-seller-content text-left">
                                        ...
                                        <div class="top-seller-btn">
                                            <a href="shop.html" class="btn theme-btn">Mua Ngay</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-7 col-lg-7">
                            <div class="top-seller text-right mb-50">
                                <img src="../user/img/banner/top-seller/banner2.jpg" alt="">
                                <div class="sellet-2-content">
                                    ...
                                    <div class="top-seller-btn">
                                        <a href="shop.html" class="btn theme-btn-2 mr-20"> xem chi tiết</a>
                    ...
                    <div class="row">
                        <div class="col-xl-5 col-lg-12">
                            <div class="area-title mb-50">
                                ...
                                <p>Khám phá các sản phẩm được xem nhiều gần đây</p>
                            </div>
                        </div>
                        <div class="col-xl-7 col-lg-12">
                            <div class="product-tab mb-40">
                                <ul class="nav product-nav justify-content-xl-end" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="home-tab1" data-toggle="tab" href="#home1" role="tab"
                                            aria-controls="home" aria-selected="true">Đèn Bàn</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="profile-tab1" data-toggle="tab" href="#profile1" role="tab"
                                            aria-controls="profile" aria-selected="false">Nội Thất</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="contact-tab6" data-toggle="tab" href="#contact1" role="tab"
                                            aria-controls="contact" aria-selected="false">Ghế Ngồi</a>
                                    </li>
                                    <li class="nav-item">
                                        ...
                                        <div class="product-slider owl-carousel">
                                            <div class="pro-item">
                                                <div class="product-wrapper mb-50">
                                                    <div class="product-img mb-25">
                                                        <a href="product-details.html">
                                                            <img src="../user/../user/img/product/pro9.jpg" alt="">
                                                            <img class="secondary-img" src="../user/../user/img/product/pro4.jpg" alt="">
                                                        </a>
                                                        <div class="product-action text-center">
                                                            <a href="#" title="Shoppingb Cart">
                                            ...
                                            <div class="pro-item">
                                                <div class="product-wrapper mb-50">
                                                    <div class="product-img mb-25">
                                                        <a href="product-details.html">
                                                            <img src="../user/../user/img/product/pro10.jpg" alt="">
                                                            <img class="secondary-img" src="../user/../user/img/product/pro4.jpg" alt="">
                                                        </a>
                                                        <div class="product-action text-center">
                                                            <a href="#" title="Shoppingb Cart">
                                            ...
                                            <div class="pro-item">
                                                <div class="product-wrapper mb-50">
                                                    <div class="product-img mb-25">
                                                        <a href="product-details.html">
                                                            <img src="../user/../user/img/product/pro11.jpg" alt="">
                                                            <img class="secondary-img" src="../user/../user/img/product/pro6.jpg" alt="">
                                                        </a>
                                                        <div class="product-action text-center">
                                                            <a href="#" title="Shoppingb Cart">
                                            ...
                                            <div class="pro-item">
                                                <div class="product-wrapper mb-50">
                                                    <div class="product-img mb-25">
                                                        <a href="product-details.html">
                                                            <img src="../user/../user/img/product/pro12.jpg" alt="">
                                                            <img class="secondary-img" src="../user/../user/img/product/pro8.jpg" alt="">
                                                        </a>
                                                        <div class="product-action text-center">
                                                            <a href="#" title="Shoppingb Cart">
            ...
            <section class="upcoming-product-area pos-relative box-90 pt-120 pb-120" data-background="../user/img/bg/bg.jpg">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="area-title text-center mb-50">
                                <h2>Tin Tức Hot</h2>
                                <p>Cập nhật ngay những tin tức mới nhất!</p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            <div class="latest-news mb-40">
                                <div class="news__thumb mb-25">
                                    <img src="../user/img/blog/latest/lb1.jpg" alt="">
                                </div>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            <div class="latest-news mb-40">
                                <div class="news__thumb mb-25">
                                    <img src="../user/img/blog/latest/lb2.jpg" alt="">
                                </div>
                                <div class="news__caption white-bg">
                                    <div class="news-meta mb-15">
                                        <span><i class="far fa-calendar-check"></i> Sep 15, 2018 </span>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            <div class="latest-news mb-40">
                                <div class="news__thumb mb-25">
                                    <img src="../user/img/blog/latest/lb3.jpg" alt="">
                                </div>
                                <div class="news__caption white-bg">
                                    <div class="news-meta mb-15">
                                        <span><i class="far fa-calendar-check"></i> Sep 15, 2018 </span>
                            ...
                            <div class="col-xl-4">
                                <div class="subscribe d-flex fix">
                                    <div class="subscribe-icon">
                                        <img src="../user/img/icon/subscribe.png" alt="">
                                    </div>
                                    <div class="area-title white-color mb-50">
                                        <h2>Bản Tin</h2>
                                        <p>Đăng ký tại đây để biết những cập nhật mới nhất</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-8">
                                <div class="subscribe fix">
                                    <div class="subscribe-form mb-50">
                                        <form action="#">
                                            ...
                                            <button class="btn theme-btn" type="submit">đăng ký ngay</button>
                                        </form>
                                    </div>
                                </div>
                            </div>

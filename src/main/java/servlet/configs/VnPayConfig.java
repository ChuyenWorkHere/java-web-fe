...
public class VnPayConfig {
    ...
    public static String vnp_ReturnUrl = "http://localhost:8080/Furniture/customer/checkout-callback"; // Sửa lại port nếu cần
    ...
    public static String getSecureHash(Map<String, String> fields) {

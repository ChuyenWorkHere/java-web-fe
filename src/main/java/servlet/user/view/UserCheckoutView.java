...
public class UserCheckoutView extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.append("                                            <input type=\"text\" name=\"lastName\" placeholder=\"\" />");
		out.append("                                        </div>");
		out.append("                                    </div>");
		out.append("                                    <div class=\"col-md-6\">");
		out.append("                                        <div class=\"checkout-form-list\">");
		out.append("                                            <label>Họ <span class=\"required\">*</span></label>");
		out.append("                                            <input type=\"text\" name=\"firstName\" placeholder=\"\" />");
		out.append("                                        </div>");
		out.append("                                    </div>");
		...
		out.append("                                            <input type=\"text\" name=\"address\" placeholder=\"Địa chỉ chi tiết\" />");
		out.append("                                        </div>");
		out.append("                                    </div>");
		out.append("                                    <div class=\"col-md-12\">");
		out.append("                                        <div class=\"checkout-form-list\">");
		...
		out.append("                                            <input type=\"text\" name=\"phone\" placeholder=\"\" />");
		out.append("                                        </div>");
		out.append("                                    </div>");
		out.append("                                    <div class=\"col-md-6\">");
		out.append("                                        <div class=\"checkout-form-list\">");
		out.append("                                            <label>Địa chỉ email <span class=\"required\">*</span></label>");
		out.append("                                            <input type=\"email\" name=\"email\" placeholder=\"\" />");
		out.append("                                        </div>");
		out.append("                                    </div>");
		out.append("                                </div>");
		out.append("                            </div>");

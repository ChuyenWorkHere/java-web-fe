...
public class UserCheckoutView extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(cartItems.isEmpty()) {
			...
			out.append("                                <h4 class=\"mb-3\">Giỏ hàng của bạn đang trống</h4>");
			out.append("                                <p class=\"text-muted mb-4\">Bạn không thể thanh toán khi chưa có sản phẩm nào. Vui lòng quay lại cửa hàng để mua sắm.</p>");
			out.append("                                <a href=\"" + request.getContextPath() + "/public/shop\" class=\"btn theme-btn\">Quay lại cửa hàng</a>");
			out.append("                            </div>");
			out.append("                        </div>");
			out.append("                    </div>");
		} else {

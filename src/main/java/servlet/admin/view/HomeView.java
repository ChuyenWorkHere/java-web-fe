...
public class HomeView extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
	    ...
	    out.append("        <div class=\"col-xl-3 col-md-6\">");
	    ...
	    out.append("                  <span class=\"text-success small pt-1 fw-bold\">12%</span> <span");
	    out.append("                    class=\"text-muted small pt-2 ps-1\">tăng</span>");
	    out.append("");
	    out.append("                </div>");
	    out.append("              </div>");
	    out.append("            </div>");
	    ...
	    out.append("                  <span class=\"text-success small pt-1 fw-bold\">8%</span> <span");
	    out.append("                    class=\"text-muted small pt-2 ps-1\">tăng</span>");
	    out.append("");
	    out.append("                </div>");
	    out.append("              </div>");
	    ...
	    out.append("");
	    out.append("            <div class=\"card-body\">");
	    out.append("              <h5 class=\"card-title\">Khách Hàng <span>| Năm này</span></h5>");
	    out.append("");
	    out.append("              <div class=\"d-flex align-items-center\">");
	    out.append("                <div class=\"card-icon rounded-circle d-flex align-items-center justify-content-center\">");
	    ...
	    out.append("                  <span class=\"text-danger small pt-1 fw-bold\">12%</span> <span");
	    out.append("                    class=\"text-muted small pt-2 ps-1\">giảm</span>");
	    out.append("");
	    out.append("                </div>");
	    out.append("              </div>");
	    out.append("");
	    ...
	    out.append("");
	    out.append("            <div class=\"card-body\">");
	    out.append("              <h5 class=\"card-title\">Đánh Giá <span>| Năm này</span></h5>");
	    out.append("");
	    out.append("              <div class=\"d-flex align-items-center\">");
	    out.append("                <div class=\"card-icon rounded-circle d-flex align-items-center justify-content-center\">");
	    ...
	    out.append("        <div class=\"col-lg-4 new-customer\">");
	    out.append("");
